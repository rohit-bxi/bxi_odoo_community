...
#############################################################################
{
    ...
    "Days/Hours durations",
    "description": """Advanced Project Management System designed to streamline
    every aspect of your projects. It ships three access levels
    (Administrator, Manager and User) covering tasks, sub-tasks, timesheets
    and milestones, and adds a Days/Hours duration unit computed from the
    start date and the deadline of projects, milestones, tasks, sub-tasks and
    project issues.""",
    'author': 'Cybrosys Techno Solutions',
    'company': 'Cybrosys Techno Solutions',
    'maintainer': 'Cybrosys Techno Solutions',
    'website': "https://www.cybrosys.com",
    'depends': ['project', 'hr', 'hr_timesheet', 'project_hr_skills'],
    'data': [
        ...
        'report/project_pmo_report_views.xml',
