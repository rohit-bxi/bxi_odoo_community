...
class ProjectProject(models.Model):
    ...
    _inherit = ['project.project', 'project.duration.mixin']

    _duration_start_field = 'date_start'
    _duration_end_field = 'date'
    ...
    @api.depends('date_start', 'date', 'duration_type')
    def _compute_duration(self):
        """Recompute the project duration whenever its bounds change."""
        return super()._compute_duration()

    @api.constrains('date_start', 'date')
    def _check_duration_dates(self):
        """Reject projects whose expiration date precedes their start date."""
